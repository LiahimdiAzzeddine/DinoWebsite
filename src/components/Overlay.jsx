...
const Card = ({
  ...
  return (
    <motion.div
      ...
      ref={ref}
      className={`
        relative block w-full max-w-[440px] z-[200]
    ...
    >
      <div className="wrapper flex flex-col gap-6">
        <div>
          ...
          <div
            className={`font-bold RocGroteskBold flex items-center text-3xl md:text-4xl leading-9 ${id === "section1" ? "sm:min-h-[2.3em] min-h-[2.5em]" : ""
              }`}
          >
            {title}
          </div>
