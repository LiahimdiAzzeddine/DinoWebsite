...
export function Web1(props) {
  ...
  useLayoutEffect(() => {
    ...
    if(actions["Sphere.008Action"]){
      actions["Sphere.008Action"].play()
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      ...
      {currentModel=="Model1" &&(
        ...
        />
        <group name="Cube025" position={[-0.698, 1.564, -0.811]} />
        <group name="Sphere" position={[-3.738, 1.531, -0.738]} scale={[0.109, 0.107, 0.107]}>
          <mesh
            name="Sphere_1"
            castShadow
            receiveShadow
        ...
        <group name="Sphere008" position={[-3.896, 1.724, 1.56]} scale={0.107}>
          <mesh
            name="Sphere003_1"
            castShadow
            receiveShadow
