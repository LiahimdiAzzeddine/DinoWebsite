...
export function DinoOffice({props,currentPage }) {
  ...
  const handleCharacterClick = () => {
    const action = actions['Retopo_CubeAction'] 
    if (action) {
  ...
  useScrollAnimation({
    actions,
    animationName: 'Camera.001Action',
    currentPage,
    pageRange: [0, 3],
    excludedAnimations: [
      "Camera.001Action",
  ...
  const isActive = currentPage < 3;

  return (
    <group ref={group} {...props} dispose={null}>
    <group name="Scene">
      <group name="Scene_1" position={[-0.017, -0.25, -0.185]} scale={0.437}>
        <mesh
          name="Plane001"
          castShadow
          receiveShadow
        ...
        />
        <group name="Cube013" position={[-1.772, 2.339, 1.155]} rotation={[0, -0.155, 0]}>
          <mesh
            name="Cube024"
            castShadow
            receiveShadow
        ...
        <PerspectiveCamera
          ...
          near={0.1}
          fov={22.895}
          position={[8.606, 11.477, 16.792]}
          rotation={[-0.533, 0.238, 0.096]}
        />)}
        <mesh
          name="Cylinder004"
          castShadow
        ...
        <group name="Empty002" position={[0.67, 2.386, 1.927]}>
          <group name="Retopo_Cube" rotation={[0, 1.005, 0]} scale={0.29}  onClick={handleCharacterClick} >
            <mesh
              name="mesh"
              castShadow
              receiveShadow
        ...
        <group name="Empty004" position={[1.857, 1.969, 1.487]} scale={0.342}>
          <group name="Cube004" scale={[3.169, 3.251, 3.169]}           onClick={handleMushroomClick}          >
            <mesh
              name="Cube009"
              castShadow
              receiveShadow
