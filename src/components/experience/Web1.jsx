  ...
  useLayoutEffect(() => {
    ...
    const playActionOnce = (actionName, sectionID, scrollSpeed = 1) => {
      ...
      const trigger = ScrollTrigger.create({
        ...
        //   });
        // },
        onToggle: ({ isActive,getVelocity }) => {
          const currentDirection = scrollDirectionRef.current;
          console.log("Direction fiable:", currentDirection,getVelocity());
          const animationName = currentDirection > 0 ? "UP" : "Down";
          console.log("🚀 ~ mm.add ~ animationName:", animationName)
         
            playActionOnce(animationName, sectionID,getVelocity());
